...
import org.dsa.linked_list.BasicList;
import org.dsa.linked_list.LinkedListImpl;

public class TrainLinkedListApp {
    BasicList<TrainCar> train = new LinkedListImpl<>();
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\nSize of the train is: " + app.trainSize());
    ...
    private void secondStop() {
        //at this stop we need to pull off all the tanker cars.  They should start at position 5 and there's 3 of them
