...
import org.dsa.queue.ArrayListQueueImpl;
import org.dsa.queue.ArrayQueueImpl;
import org.dsa.queue.BasicQueue;

public class SnowbirdLiftApp {
//    BasicQueue<Gad2Chair> gad2Lift = new ArrayQueueImpl<>();
    BasicQueue<Gad2Chair> gad2Lift = new ArrayListQueueImpl<>();
