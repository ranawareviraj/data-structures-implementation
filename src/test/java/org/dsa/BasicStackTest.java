...
import org.dsa.stack.ArrayListStackImpl;
import org.dsa.stack.BasicStack;

public class BasicStackTest {
    //    BasicStack<String> stack = new ArrayStackImpl<String>();
    BasicStack<String> stack = new ArrayListStackImpl<>();
